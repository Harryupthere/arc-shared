    ...
    try {
		...
		*/
        /*
		 ...
		 SPDX-License-Identifier: Apache-2.0
		*/
        var ea, va, ya, Ea, Ia, Ja, Na, Oa, Pa, Ra, bb, eb, fb, gb, hb, w, ib, lb, mb, nb, pb, tb;
        _.aa = function (a, b) {
        ...
        Oa = function (a) {
            ...
            if (1 == b && Array.isArray(arguments[0])) return Oa.apply(null, arguments[0]);
            ...
            e.all = function (g) {
                ...
                return l.done
                    ...
                    : new e(function (m, n) {
                          ...
                          var r = [],
                              p = 0;
                          do r.push(void 0), p++, c(l.value).Ic(q(r.length - 1), n), (l = h.next());
                          while (!l.done);
                      });
            };
            return e;
        ...
        w("Map", function (a) {
            ...
            c.prototype.delete = function (h) {
                h = d(this, h);
                return h.va && h.list ? (h.list.splice(h.index, 1), h.list.length || delete this[0][h.id], (h.va.cb.next = h.va.next), (h.va.next.cb = h.va.cb), (h.va.head = null), this.size--, !0) : !1;
            };
        ...
        Dd.prototype.add = function (a, b, c, d, e) {
            ...
            a || ((a = this.g[f] = []), this.h++);
            var g = Ed(a, b, d, e);
            -1 < g ? ((b = a[g]), c || (b.Hc = !1)) : ((b = new Bd(b, this.src, f, !!d, e)), (b.Hc = c), a.push(b));
            return b;
        };
        ...
        _.Rd = function (a, b, c, d, e) {
            if (Array.isArray(b)) for (var f = 0; f < b.length; f++) _.Rd(a, b[f], c, d, e);
        ...
        _.k.dispatchEvent = function (a) {
            ...
            if (b) for (f = 0; !a.h && f < b.length; f++) (g = a.currentTarget = b[f]), (e = Ud(g, d, !1, a) && e);
            return e;
        };
        _.k.I = function () {
            _.G.O.I.call(this);
        ...
        var Ve = function (a) {
            ...
            We = function (a, b, c, d, e) {
                ...
                Xe(a, b) ? d && (_.u(a.A, b) || a.A.push(b), Ve(a)) : d && (_.u(a.A, b) || a.A.push(b));
            };
            ...
            if (0 !== e.length) {
                ...
                a = (0, _.A)(this.B.H, this.B, _.ua(e), this.g, {
                    ...
                    ie: function (f) {
                        ...
                        401 == f ? ($e(d, new Cb.Ha(Cb.Ha.g.We, f)), (d.h.length = 0)) : 410 == f ? (af(d, new Cb.Ha(Cb.Ha.g.Ue, f)), bf(d)) : 3 <= d.D ? (af(d, new Cb.Ha(Cb.Ha.g.Ie, f)), bf(d)) : d.M(d.o, !0, 8001 == f);
                    },
        ...
        var Ze = function (a, b) {
            ...
            Te = function (a) {
                a.j == a.F && ((a.j = null), a.F.onLoad((0, _.A)(a.rf, a)) && $e(a, new Cb.Ha(Cb.Ha.g.Bd)), Ve(a));
            },
            na = function (a) {
                if (a.j) {
                    var b = a.j.La(),
        ...
        var af = function (a, b) {
            ...
            $e = function (a, b) {
                ...
                for (e = 0; e < c.length; e++) a.g[c[e]] && a.g[c[e]].ie(b);
                a.o.length = 0;
                Ve(a);
            },
            bf = function (a) {
        ...
        _.nf = function (a, b) {
            ...
            if (1 < c) {
                ...
                if (a instanceof _.nf) for (c = a.Cb(), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
        ...
        _.uf = function (a, b, c) {
            ...
            else for (var d = _.tf(a), e = _.sf(a), f = e.length, g = 0; g < f; g++) b.call(c, e[g], d && d[g], a);
        };
        vf = function (a, b) {
            if ("function" == typeof a.every) return a.every(b, void 0);
            if (_.da(a) || "string" === typeof a) return Array.prototype.every.call(a, b, void 0);
            for (var c = _.tf(a), d = _.sf(a), e = d.length, f = 0; f < e; f++) if (!b.call(void 0, d[f], c && c[f], a)) return !1;
            return !0;
        };
        var xf;
        _.wf = function (a) {
        ...
        Lf = function (a, b, c) {
            if (Array.isArray(b)) for (var d = 0; d < b.length; d++) Lf(a, String(b[d]), c);
        ...
        _.Qf = function (a) {
            ...
            var b;
            a instanceof _.Qf
                ? ((this.o = a.o), _.Rf(this, a.l), (this.A = a.A), _.Sf(this, a.h), Tf(this, a.B), _.Uf(this, a.j), Vf(this, Wf(a.g)), (this.s = a.s))
                : a && (b = String(a).match(_.If))
                ? ((this.o = !1), _.Rf(this, b[1] || "", !0), (this.A = Xf(b[2] || "")), _.Sf(this, b[3] || "", !0), Tf(this, b[4]), _.Uf(this, b[5] || "", !0), Vf(this, b[6] || "", !0), (this.s = Xf(b[7] || "")))
                : ((this.o = !1), (this.g = new _.Yf(null, this.o)));
        };
        ...
        var Hg = function (a, b, c, d, e, f) {
            if (Array.isArray(c)) for (var g = 0; g < c.length; g++) Hg(a, b, c[g], d, e, f);
            else {
        ...
        _.Eg.prototype.Pa = function (a, b, c, d, e) {
            if (Array.isArray(b)) for (var f = 0; f < b.length; f++) this.Pa(a, b[f], c, d, e);
            else
                (c = c || this.handleEvent),
                    ...
                    (c = Ld(c)),
                    (d = !!d),
                    (b = _.zd(a) ? a.lc(b, c, d, e) : a ? ((a = _.Nd(a)) ? a.lc(b, c, d, e) : null) : null),
        ...
        _.Sg.prototype.send = function (a, b, c, d) {
            ...
            !_.u(Ug, b) || d || e || c.set("Content-Type", "application/x-www-form-urlencoded;charset=utf-8");
            b = _.y(c);
            ...
            try {
                Xg(this), 0 < this.B && (this.A = _.Rg(this.T, this.B, this)), (this.s = !0), this.g.send(a), (this.s = !1);
            } catch (g) {
                Wg(this);
            }
        };
        ...
        _.Sg.prototype.abort = function (a) {
            this.g && this.h && ((this.h = !1), (this.j = !0), this.g.abort(), (this.j = !1), (this.l = a || 7), this.dispatchEvent("complete"), this.dispatchEvent("abort"), Zg(this));
        };
        _.Sg.prototype.I = function () {
            this.g && (this.h && ((this.h = !1), (this.j = !0), this.g.abort(), (this.j = !1)), Zg(this, !0));
            _.Sg.O.I.call(this);
        };
        _.Sg.prototype.M = function () {
            this.Va() || (this.G || this.s || this.j ? $g(this) : this.V());
        };
        _.Sg.prototype.V = function () {
            $g(this);
        };
        var $g = function (a) {
                if (a.h && "undefined" != typeof wb && (!a.D[1] || 4 != _.ah(a) || 2 != _.bh(a)))
                    if (a.s && 4 == _.ah(a)) _.Rg(a.M, 0, a);
                    else if ((a.dispatchEvent("readystatechange"), 4 == _.ah(a))) {
                        a.h = !1;
                        try {
                            _.ch(a) ? (a.dispatchEvent("complete"), a.dispatchEvent("success")) : ((a.l = 6), Yg(a));
                        } finally {
                            Zg(a);
                        }
                    }
        ...
        _.ch = function (a) {
            ...
            if (!c) {
                if ((b = 0 === b)) (a = String(a.o).match(_.If)[1] || null), !a && _.t.self && _.t.self.location && (a = _.t.self.location.protocol.slice(0, -1)), (b = !Tg.test(a ? a.toLowerCase() : ""));
                c = b;
            }
            return c;
        };
        ...
        fh.prototype.H = function (a, b, c) {
            ...
            var e = d.ie,
                f = d.Gi;
            a = hh(this, a, b, d.oh, c);
            ih(this, a, e, f, c);
        };
        var hh = function (a, b, c, d, e) {
                d = void 0 === d ? {} : d;
                var f = [];
                jh(a, b, c, d, void 0 === e ? !1 : e, function (g) {
                    f.push(g.La());
                });
                return f;
            },
            jh = function (a, b, c, d, e, f, g) {
                g = void 0 === g ? {} : g;
                b = _.y(b);
                for (var h = b.next(); !h.done; h = b.next()) {
                    var l = h.value;
                    h = c[l];
                    (!e && (a.s.has(l) || h.g)) || g[l] || ((g[l] = !0), (l = d[l] ? Object.keys(d[l]) : []), jh(a, h.h.concat(l), c, d, e, f, g), f(h));
                }
            },
            ih = function (a, b, c, d, e) {
                ...
                for (
                    var h = function (q, r) {
                            for (var p = [], x = 0, C = Math.floor(q.length / r) + 1, I = 0; I < r; I++) {
                                var R = (I + 1) * C;
                                p.push(q.slice(x, R));
                                x = R;
                            }
                    ...
                    var m = kh(a, l, !!e, !0);
                    if (2e3 >= m.length) {
                        if ((l = lh(a, l, e))) f.push(l), Le(g, l.g);
            ...
            lh = function (a, b, c) {
                var d = kh(a, b, !(void 0 === c || !c));
                a.J.push(d);
                b = _.y(b);
                for (c = b.next(); !c.done; c = b.next()) a.s.add(c.value);
                if (a.B) (a = _.md(document, "SCRIPT")), _.ab(a, _.db(d)), (a.type = "text/javascript"), (a.async = !1), document.body.appendChild(a);
                else {
                    var e = new nh(),
                        f = new _.Sg(0 < a.j.length ? new Ng() : void 0);
            ...
            mh = function (a, b, c, d) {
                ...
                else for (a = 0; a < b.length; a++) (d = b[a]), ph(d.o, d.Ea) || (c && c(8001));
                (e || g) &&
                    -1 != f &&
                    _.bc(h, function (m) {
                        m.cancel();
        ...
        var eh = function () {
            ...
            rh = function (a) {
                for (; 5 > a.g && a.h.length; ) sh(a, a.h.shift());
            },
            sh = function (a, b) {
                a.g++;
                Ie(
        ...
        Af({
            ...
            initialize: function (a) {
                ...
                var e,
                    f = _.t._F_jsUrl;
                f && (e = qh(f));
                !e && (f = document.getElementById("base-js")) && ((e = f.src ? f.src : f.getAttribute("href")), (e = qh(e)));
                e || (e = qh(uh));
                e || ((e = document.getElementsByTagName("script")), (e = qh(e[e.length - 1].src)));
                if (!e) throw Error("$");
                e = new fh(e);
                c && (e.o = c);
                d && (e.l = d);
...
//# sourceURL=/_/translate_http/_/js/k=translate_http.tr.en_GB.J8YmFT6RXg4.O/am=wA/d=1/rs=AN8SPfr-teMzctIXfVm5BXC0PU-bAAZHDQ/m=el_conf
// Configure Constants
(function () {
    ...
    (function () {
        ...
        c._ps = "https://www.gstatic.com/_/translate_http/_/ss/k=translate_http.tr.26tY-h6gH9w.L.W.O/am=wA/d=0/rs=AN8SPfpPTNr3cQN8QhzqvQYsNrDu3oHhow/m=el_main_css";
        c._plla = oph + "/v1/supportedLanguages";
        c._puh = "translate.google.com";
        c._cnal = {};
        _loadCss(c._ps);
        _loadJs("https://translate.googleapis.com/_/translate_http/_/js/k=translate_http.tr.en_GB.J8YmFT6RXg4.O/am=AAQ/d=1/exm=el_conf/ed=1/rs=AN8SPfplru0zGaDIemj_zpm0qmmyrbUMZA/m=el_main");
        _exportMessages();
        _exportVersion("TE_20240423");
    })();
})();
