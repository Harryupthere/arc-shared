...
function Statistics() {
  return (
    <Paper className="statistics main-paper">
     <div className='main-heading'> <h2>Statistics</h2></div>
      <Grid container spacing={0}>
        ...
        <Grid size={{xs:4}}>
         ...
         <Grid size={{xs:4}}>
          <Box className="stat-item">
            <Typography variant="body2" className="label">Sharpe Ratio</Typography>
            <Typography variant="h6" className="value">0.71</Typography>
          </Box>
        </Grid>
      </Grid>
    </Paper>
